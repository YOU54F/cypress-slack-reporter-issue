...
const CA_COMPANY_NUMBER = '000 000 019';
const CA_PHONE_NUMBER_FIELD = 'input[name=phone]';
const CA_PHONE_NUMBER = '0487878787';
...
const CA_STREET_ADDRESS = '14/10 Eastern Road';
const CA_CITY = 'Canberra';
const CA_POSTAL_CODE = '2600';
const CA_NUMBER_OF_EMPLOYEES = '50';
const SELECT_COUNTRY = '[name=scheme_country]';
var today = new Date();
var time = today.getHours() + "-" + today.getMinutes() + "-" + today.getSeconds();
const CA_COMPANY_NAME = 'AusCompany '+ time + ' ' + Cypress.moment().format('MMM DD YYYY');
//Verificatoin flow
...
const POST_CODE_FIELD = ':nth-child(11) > .InputFloatingLabel__StyledInput-j02spn-1';
...
const ADDRESS_LINE_2 = '17/13 Western Road';
const SUBURB_FIELD = ':nth-child(9) > .InputFloatingLabel__StyledInput-j02spn-1';
const STATE_FIELD = ':nth-child(10) > .InputFloatingLabel__StyledInput-j02spn-1';
    ...
    context('Registration', () => {
        it("Create Account Form", function () {
            cy
                ...
                .get(SELECT_COUNTRY).select('Australia')
        ...
        it("Verification flow", function () {
            cy
                ...
                .then((file) => {
                    ...
                    getIframeBody().find(PRICE_VALUE).wait(2000).should('contain', '$10.00')
                    ...
                    getIframeBody().find(IFRAME_TITLE).click().wait(500).click()
                    getIframeBody().find(IFRAME_COUNTRY_DROPDOWN).wait(2000).select('Australia')
                    ...
                    getIframeBody().find(NEXT_BUTTON_NEXTSTEP).wait(2000).click().wait(4000)
                    getIframeBody().find(PRICE_VALUE).should('contain', '$10.00')
                    ...
                    getIframeBody().find(ACCOUNT_INFO).should('contain', 'Australia')
                    getIframeBody().find(ACCOUNT_INFO).should('contain', 'ending 4242')
                    getIframeBody().find(NEXT_BUTTON_TEXT_LASTSTEP).should('contain', 'Pay $10.00 & subscribe')
